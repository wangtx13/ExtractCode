...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Create a new folder
        String folderPath = "/Users/apple/NetBeansProjects/ExtractCode/output/allcode-" + timeStampStr + "/";
        createDir(folderPath);
        
        File inputRootFile = new File("/Users/apple/NetBeansProjects/ExtractCode/sourceCode");
